...
<body>
    ...
    <div id='mainDiv'>
        ...
        <div class='cardTitles'>
            ...
            <div class='cardHeader yellowHeader'>
                <div class="HeaderCols">
                    ...
                    <div class="headerTxt12">
                        <span class="textBlack" style="font-size: 3vw;">
                            Mapas de Correlación</span>
                    </div>
                </div>
            </div>
            <!-- Card Content 1.4 -->
            <div class="mapaContent ">
                <div id="heatmapContentDiv">
                    <div id="imageFilterDiv">
                        <select class="form-select form-select-lg text-white" style="--bs-bg-opacity: 1; background-color: #53606E; 
                            ...
                            <option selected>Selecciona un agrupamiento...
                            </option>
                            <option value="1">Todos los refrigeradores</option>
                            <option value="2">Familia: 4W3G80 </option>
                            <option value="3">Familia: 4W3G12</option>
                            <option value="4">Familia: 6w3n80</option>
                        </select>
                    </div>
                    <div id="imagemapa">
                        <img class="heatMap" src="./mapa de calor.png">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class='cardTitles'>
            ...
            <!-- Card Content 4  -->
            <div class="cardTitlesContent ">
                <img src="https://lh6.googleusercontent.com/o18UTbi5Xf9LMuwXZlEoDo-eu-HrYeR2dSbA7tN__Y27MN9w7j_1mVArv2TCMjCNkds=w2400" class="imgBackground1">
                <div class="imgBackground105">
                    <span></span>
                </div>
                <div class="titleCenterText">
        ...
        <!--CARD 4.2 ( INFO Below Rating Point)-->
        <div class='cardTitles'>
            <!-- Card Header 4.2 -->
            <div class='cardHeader yellowHeader'>
                <div class="HeaderCols">
            ...
            <div class="cardTitlesContent ">
                <div class="cardbrp">
                    <div class="cardBRPColumns ">
                        <span class="textBlack" style="font-size:36px ;">Below Rating Point </span>
                        <span class="textBlack" style="font-size:36px ; margin-bottom: 4vw">
                            (4W3G80) </span>

                        <span class="textBlack" style="font-size:26px ;margin-bottom: 4vw"> <span class="textYellow"
                                style="font-size:26px ;">
                                15% </span> de los datos se <br>
                            encuentran sobre el rango </span>
                        <span class="textBlack" style="font-size:26px ;"> <span class="textYellow"
                                style="font-size:26px ;">
                                32% </span> de los datos se <br>
                            encuentran debajo del rango </span>
                    </div>
                    <div class="cardBRPColumns ">
                        <span class="textBlack" style="font-size:36px ;">Below Rating Point </span>
                        <span class="textBlack" style="font-size:36px ; margin-bottom: 4vw">
        ...
        <div class="cardTitles">
            ...
            <div class="cardTitlesContent" style="height: 1080px;">
                <div id="tendenciasWrapper">
                    <div id="tendenciasContentTitle">
                        <span class="textBlack" style="font-size:36px ;">Energy Consumed Kwh/year</span>
                    </div>
